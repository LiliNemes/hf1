...
#
get_filename_component(filename "C:/BME/grafika/hf1/cmake-build-debug/glew-prefix/src/glew-2.1.0-win32.zip" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-glew${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-glew${i}")
