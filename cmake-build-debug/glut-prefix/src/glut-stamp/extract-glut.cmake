...
#
get_filename_component(filename "C:/BME/grafika/hf2/cmake-build-debug/glut-prefix/src/freeglut-MinGW.zip" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-glut${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-glut${i}")
